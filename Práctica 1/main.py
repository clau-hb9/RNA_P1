...
def main():
    ...
    datos_entrenamiento = leer(carpeta_datosProcesados, 'DatosEntrada_entrenamientoPrueba')
    datos_validacion = leer(carpeta_datosProcesados, 'DatosEntrada_validacionPrueba')
